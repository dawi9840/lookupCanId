...
public class SignalReceiver {
    ...
    public static Queue<String> getSignalQueue(String inputSimulateCanSignals) {
        ...
        // System.out.println("tmpSignalQueue: " + tempQueue);
        return tempQueue;
    }
    ...
    /** Test receive simulate CAN signals to get a String format data with queue limit length. */
    private static void testReceiveCanSignalsToGetAStringData(){
        int count = 255;
