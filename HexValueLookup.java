...
public class HexValueLookup {
         ...
         */
        public static Map<String, String[]> getCorrespondingTable(String[] canIdSignalsTable, String[][] hexValueTable,
                        int chooseMode) {
         ...
         ***/
        public static String getHexValueStatus(String specificID, String hexValue,
                        Map<String, String[]> correspondingTable) {
        ...
        /* Test using a specificID to find the DMS HexValueStatus. */
        private static void testGetDMSHexValueStatus() {  
                int selectMode = 3;
                String[][] hexValueTable = gethexValueTable(selectMode);
                String[] canIdSignalsTable = SpecificCanIdDataset.getSpecificCanIdDatasets(selectMode);
                Map<String, String[]> correspondingTable = getCorrespondingTable(canIdSignalsTable, hexValueTable, selectMode);
